  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        <h1 className="text-4xl mb-10 text-[#D2AF84] font-medium">
        ...
        <div className="space-y-8">
          ...
          <p>
            Our {len} luxury cabins provide a cozy base, but the real freedom
      ...
      <div className="col-span-2 relative aspect-square">
        <Image
          ...
          placeholder="blur"
          quality={80}
          alt="Family that manages T he Wild Oasis"
        />
      </div>
